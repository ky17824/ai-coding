...
describe("dashboard execution summary", () => {
  it("keeps the AI GTM plan summary without duplicate action lists", () => {
    expect(source).toContain('en ? "AI GTM PLAN" : "AI GTM 계획(AI GTM Plan)"');
    expect(source).toContain('className="plan-summary"');
