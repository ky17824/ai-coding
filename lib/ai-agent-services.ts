...
const specialists: AiAgentDefinition[] = [
  ["ai-market-intelligence", 199000, "심층시장조사", "In-depth Market Research", "후보국·ICP·TAM·SAM·SOM·교두보 시장과 경쟁구도를 근거와 함께 조사합니다.", "Research target markets, ICP, TAM, SAM, SOM, beachhead market, and competition with traceable evidence.", ["market-sizing", "target-market", "competition", "market-validation"], ["후보국·ICP 비교", "시장규모 Top-Down 및 Bottom-Up 심화 TAM, SAM, SOM, Beachhead Market (low/base/high)", "경쟁구도·근거 원장"], ["Market and ICP comparison", "In-depth Top-Down and Bottom-Up TAM, SAM, SOM, and Beachhead Market sizing (low/base/high)", "Competition and evidence ledger"]],
