...
describe("market research source verification", () => {
  it("reserves normal slots and consumes a legacy v2 upgrade only once", () => {
    expect(researchQuotaDecision(2, "legacy", null)).toBe("reserve");
    expect(researchQuotaDecision(3, "legacy", null)).toBe("legacy_upgrade");
    expect(researchQuotaDecision(3, "legacy", "2026-08-13T00:00:00Z")).toBe("limit");
    expect(researchQuotaDecision(3, "market-research-v2", null)).toBe("limit");
  });
