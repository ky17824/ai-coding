...
const ko = {
  ...
  header: {
    ...
    dashboard: "대시보드",
    assessment: "준비도 진단",
    assistant: "AI GTM 어시스턴트",
    journey: "GTM 여정",
    services: "AI 전문가 서비스",
    aiServices: "AI 전문가 서비스",
    admin: "운영",
    account: "마이페이지",
    signOut: "로그아웃",
    signIn: "로그인"
  ...
  preview: {
    ...
    scoreLabel: "단계별 준비도",
    chartLabels: ["준비 1단계", "준비 2단계", "준비 3단계"],
    gateLabel: "통과 기준 80%",
    verdictBefore: ["준비 1단계 통과 전입니다:", "유료 고객 증거를 먼저 숫자로 바꿔야 합니다."],
    verdictAfter: ["준비 1단계를 통과했습니다:", "이제 목표 국가와 고객군을 확정할 차례입니다."],
...
const en: typeof ko = {
  ...
  header: {
    ...
    assistant: "AI GTM Assistant",
    journey: "GTM Journey",
    services: "AI Expert Services",
    aiServices: "AI Expert Services",
    admin: "Admin",
    account: "My Account",
    signOut: "Sign out",
    signIn: "Sign in"
  ...
  preview: {
    ...
    scoreLabel: "Readiness by stage",
    chartLabels: ["Stage 1", "Stage 2", "Stage 3"],
    gateLabel: "Pass at 80%",
    verdictBefore: ["Stage 1 not yet passed:", "Turn paying-customer evidence into numbers first."],
    verdictAfter: ["Stage 1 passed:", "Next, confirm the target country and customer segment."],
