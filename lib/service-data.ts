...
export const SAMPLE_SERVICES: ServiceOffering[] = [
  {
    ...
    providerName: "김서윤",
    providerTitle: "B2B SaaS RevOps 파트너",
    type: "mentoring",
    title: "글로벌 확장 전 Unit Economics 점검",
    description:
      "현재 고객 데이터를 기준으로 LTV:CAC, CAC 회수기간, NRR의 계산 방식과 개선 우선순위를 함께 정리합니다.",
    price: 180000,
    durationLabel: "90분",
  ...
  },
  {
    ...
    type: "consulting",
    title: "교두보 시장 검증 스프린트",
    description:
      "ICP를 좁히고 바텀업 TAM, 고객 인터뷰, 자발적 수요 신호를 3주 동안 검증합니다.",
    price: 2200000,
    durationLabel: "3주",
    tags: ["market-validation"],
    deliverables: ["시장 우선순위표", "인터뷰 가이드", "바텀업 TAM"],
    approved: true,
    rating: 4.8,
    reviewCount: 12
  },
  {
    id: "svc-leadership",
    providerName: "이현우",
    providerTitle: "글로벌 조직·전략 어드바이저",
    type: "mentoring",
    title: "경영진 글로벌 진출 얼라인먼트",
    description:
  ...
  },
  {
    ...
    type: "consulting",
    title: "해외 B2B 보안·컴플라이언스 갭 분석",
    description:
      "목표 고객의 보안·개인정보·조달 요건과 현재 상태의 차이를 식별하고 실행 로드맵을 만듭니다.",
    price: 2800000,
    durationLabel: "4주",
    tags: ["compliance"],
    deliverables: ["요건 갭 분석", "담당자·일정 로드맵", "전문가 검토 범위"],
    approved: true,
    rating: 4.7,
    reviewCount: 7
  },
  {
    ...
    type: "consulting",
    title: "첫 해외시장 GTM 모션 설계",
    description:
      "가격과 구매 복잡도에 맞춰 주력 모션 하나를 선택하고 검증 퍼널과 중단 기준을 설계합니다.",
    price: 1900000,
    durationLabel: "3주",
    tags: ["gtm", "market-validation"],
    deliverables: ["GTM 1페이지 캔버스", "실험 백로그", "최소 대시보드"],
    approved: true,
    rating: 4.9,
    reviewCount: 15
  },
