...
const FINAL_V5_EN_QUESTIONS = [
  ...
  "Have you tested whether the offering works under actual conditions in the initial target country?",
  "Do you record product, service, and customer-journey issues found in local testing and track their resolution?",
  "Have you identified which local promotion message or product demonstration actually generated inquiries?",
  ...
  "Is the local partner actually performing its assigned role?",
