...
export const COMPLETION_INSTRUCTIONS: Record<string, Copy> = {
  ...
  "ai-entry-requirements": { ko: "규제 요건은 공식출처를 우선하고 제품분류·법률·세무·인허가·계약 효력은 사람 검증 필요로 남기세요.", en: "Prioritize official regulatory sources and leave classification, legal, tax, approval, and contract-effect conclusions for human verification." },
