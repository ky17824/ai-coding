...
export type ReportInput = { locale: "ko" | "en"; effort: Effort; userHash: string; instructions: string; payload: unknown; includedAgentIds: string[]; files: Array<{ signedUrl: string; fileName: string; mimeType: string }>; deadlineAt: number };
export type Adapter = {
